...
```
Остальная логика описана в [ДЗ №4](https://github.com/PushinSt/TicTacToe-ilink-hm4).  
...
Остальные задачи описаны в [ДЗ №4](https://github.com/PushinSt/TicTacToe-ilink-hm4). 
#### Тестирование
